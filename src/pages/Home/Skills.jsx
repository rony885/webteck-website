...
const skillsSectionData = {
  subtitle: "GREAT IT SKILLS",

  title: {
    text1: "More Than 24+ Years Experience We Provide",
  ...
  video: {
    image: "/assets/img/normal/video_shape_1.png",
  ...
  shapes: [
    {
      id: 1,
      img: "/assets/img/shape/tech_shape_3.png",
      position: { top: "0%", left: "0%" },
    },
    {
      id: 2,
      img: "/assets/img/shape/tech_shape_4.png",
        ...
        <div className="row align-items-center">
          ...
          <div className="col-xl-6">
            <div className="title-area mb-35 text-center text-xl-start">
              <span className="sub-title">
                ...
                {skillsSectionData.subtitle}
              </span>

              <h2 className="sec-title">
                {skillsSectionData.title.text1}{" "}
                <span className="text-theme fw-normal">
                  {skillsSectionData.title.highlight}
                </span>
              </h2>
            </div>

            <p className="mt-n2 mb-25 text-center text-xl-start">
              {skillsSectionData.description}
            </p>

            <div className="pe-xxl-4">
              {skillsSectionData.skills.map((item) => (
                <div className="skill-feature" key={item.id}>
                  <h3 className="skill-feature_title">{item.title}</h3>
          ...
          <div className="col-xl-6 mt-40 mt-xl-0">
            <div className="video-box1">
              <img
                className="tilt-active"
                src={skillsSectionData.video.image}
                alt="Video"
              />

              <a
                href={skillsSectionData.video.url}
                className="play-btn popup-video"
                target="_blank"
                rel="noopener noreferrer"
              >
