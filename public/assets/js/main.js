!(function (e) {
  ...
  if (
          ...
          e(this).on("click", function (t) {
            ...
            (t.preventDefault(),
              ...
              e(a).next("ul").length > 0
                ? (e(a).parent().toggleClass(n.subMenuParentToggle),
                  e(a).next("ul").slideToggle(n.toggleSpeed),
                  e(a).next("ul").toggleClass(n.subMenuToggleClass))
                : e(a).prev("ul").length > 0 &&
                  (e(a).parent().toggleClass(n.subMenuParentToggle),
                  e(a).prev("ul").slideToggle(n.toggleSpeed),
                  e(a).prev("ul").toggleClass(n.subMenuToggleClass)));
          });
        }),
      ...
      return this.each(function () {
        ...
        (e(s).each(function () {
          ...
          e(".th-mobile-menu a").on("click", function () {
            (e(".th-menu-wrapper2").fadeOut(),
              e(".th-menu-wrapper2").removeClass("th-body-visible"));
          }),
    ...
    e(".th-menu-wrapper2").thmobilemenu(),
    ...
    (function () {
      ...
      (a(
        ...
        e(d)
          .val()
          .match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/)
          ? (e(d).removeClass("is-invalid"), (n = !0))
          : (e(d).addClass("is-invalid"), (n = !1)));
      return n;
    })() &&
      jQuery
  ...
  if (
    ...
    (gsap.registerPlugin(ScrollTrigger),
      document.querySelectorAll(".th-anim").forEach((e) => {
        ...
        (n.set(e, { autoAlpha: 1 }),
          n.from(e, 1.5, { xPercent: -100, ease: Power2.out }),
          n.from(t, 1.5, {
            xPercent: 100,
            scale: 1.3,
            delay: -1.5,
  ...
  e.fn.sectionPosition = function (t, n) {
    e(this).each(function () {
      var a,
        ...
        l,
        r = e(this);
      ((a = Math.floor(r.height() / 2)),
        (s = r.attr(t)),
        (i = r.attr(n)),
        (o = h(e(i).css("padding-top"))),
        (l = h(e(i).css("padding-bottom"))),
        "top-half" === s
          ? (e(i).css("padding-bottom", l + a + "px"),
            r.css("margin-top", "-" + a + "px"))
          : "bottom-half" === s &&
            (e(i).css("padding-top", o + a + "px"),
            r.css("margin-bottom", "-" + a + "px")));
    });
  };
  function g(t, n, a, s) {
  ...
  (e(".pricing-tabs").length &&
    (x.addEventListener("click", function () {
      ((M.checked = !1),
        x.classList.add("toggler--is-active"),
        T.classList.remove("toggler--is-active"),
    ...
    T.addEventListener("click", function () {
      ((M.checked = !0),
        ...
        x.classList.remove("toggler--is-active"),
        P.classList.add("hide"),
        S.classList.remove("hide"));
    }),
    M.addEventListener("click", function () {
      (T.classList.toggle("toggler--is-active"),
        x.classList.toggle("toggler--is-active"),
